...
function subspace.onDrawEnd()
    if screenBuffer.width ~= Screen.getScreenSize()[1] or screenBuffer.height ~= Screen.getScreenSize()[2] then
        screenBuffer = Graphics.CaptureBuffer(Screen.getScreenSize()[1],Screen.getScreenSize()[2])
    end
