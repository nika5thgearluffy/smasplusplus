return{
    ...
    --(Unused)
    ["0x0000000000000023"] = "(Unused)",
    --(Unused)
    ["0x0000000000000024"] = "(Unused)",
    --(Unused)
    ["0x0000000000000025"] = "(Unused)",
    --(✓) SMAS++ MAIN MENU: Main Menu Selection (Accessibility Settings)
    ["0x0000000000000026"] = "Accessibility Settings",
    ...
    ["0x0000000000000030"] = "For information on everything that made this episode possible,<page>It wouldn't have been possible without more than 100 people and counting.<page>To see the credits of this episode, go into the worlds folder,<page>the SMAS folder, and redirect to the CREDITS.txt file in the folder.",
    ...
    ["0x0000000000000032"] = "To begin configuring the inputs of the game,<page>please select an option depending on the controls currently being used.",
    --(✓) SMAS++ MAIN MENU: Main Menu Dialog (Configure Inputs: Which Player?)
    ["0x0000000000000033"] = "Which player would you like to assign keys to?",
    --(✓) SMAS++ MAIN MENU: Main Menu Dialog (Change PFP: Information)
    ["0x0000000000000034"] = "Your profile picture can be used when you launch Online Multiplayer, or to see who is running the game at this session.<page>Your profile picture will also be used during the story, along with your name.<page>To specify the profile picture using the keyboard, please type up the path from '___MainUserDirectory' to the profile picture you are going to use.<page>'___MainUserDirectory' is a user modifiable directory that can be used for files you specify for the episode, such as a profile picture (PNG only).<page>Don't worry if you don't want to specify one, there's already a default profile picture for you already set up.<page>But if you want to go ahead and set one up, please specify to begin anytime on that menu.<page>With that out of the way, that's how you set up a profile picture for the episode!",
    ...
    ["0x0000000000000039"] = "Since you have X2 characters disabled, you can use Battle Mode!<page>Would you like to start battle mode? We'll need to enable 2 player mode first.",
    --(✓) SMAS++ MAIN MENU: Main Menu Dialog (Classic Battle Mode Toggle: You can use!, 2P is already enabled)
    ["0x0000000000000040"] = "Since you have X2 characters disabled, you can use Battle Mode!<page>Would you like to start battle mode? You already have 2 player mode enabled for this.",
    --(✓) SMAS++ MAIN MENU: Main Menu Dialog (Classic Battle Mode Toggle: You can't use)
    ["0x0000000000000041"] = "Unfortunately, you'll need to turn on 1.3 Mode to start Classic Battle Mode.<page>This is due to stability and game breaking reasons.",
    ...
    ["0x0000000000000046"] = "Exiting battle mode activated. You'll need to manually turn off 2 player mode in the settings tab.",
    ...
    ["0x0000000000000052"] = "Save Settings",
    --(✓) SMAS++ MAIN MENU: Main Menu Dialog (Save Switching Options: Non-Editor)
    ["0x0000000000000053"] = "To begin switching the save slot, please select Begin to get started (Keyboard only).<page>THIS WILL OVERWRITE ANY SAVES THAT WERE SWITCHED TO ANY SLOT, USE WITH CAUTION!",
    --(✓) SMAS++ MAIN MENU: Main Menu Dialog (Save Switching Options: Editor)
    ["0x0000000000000054"] = "You can't do this while in the editor.<page>Please start an actual game to switch saves.<page>You can also manually do this yourself by renaming save slots in the episode folder.",
    --(✓) SMAS++ MAIN MENU: Main Menu Dialog (Save Erasing: Message 1)
    ["0x0000000000000055"] = "Once you erase your save, you CAN NOT go back unless you use tools like Recuva.<page>Erasing your save is for if you want to start over from the beginning.",
    --(✓) SMAS++ MAIN MENU: Main Menu Dialog (Save Erasing: Message 2)
    ["0x0000000000000056"] = "ARE YOU SURE YOU WANT TO ERASE YOUR SAVE DATA?",
