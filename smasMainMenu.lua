...
smasMainMenuSystem.addMenuItem{name = "Toggle Framecounter", section = smasMainMenuSystem.menuSections.SECTION_SETTINGS_MAIN, sectionItem = 7, menuType = smasMainMenuSystem.menuTypes.MENU_BOOLEAN, isFunction = false, booleanToUse = "enableFramerateCounter", isSaveData = true, isGameData = false}
...
smasMainMenuSystem.addMenuItem{name = "NES/SNES", section = smasMainMenuSystem.menuSections.SECTION_SETTINGS_CHANGERESOLUTION, sectionItem = 6, menuType = smasMainMenuSystem.menuTypes.MENU_MULTISELECT, isFunction = true, functionToRun = function() smasResolutions.changeResolution(true, true) end, multiSelectValueToUse = "resolution", multiSelectValueToSet = "nes-snes", isSaveData = true, isGameData = false, saveDataArgs = 1}
smasMainMenuSystem.addMenuItem{name = "Game Boy Advance", section = smasMainMenuSystem.menuSections.SECTION_SETTINGS_CHANGERESOLUTION, sectionItem = 7, menuType = smasMainMenuSystem.menuTypes.MENU_MULTISELECT, isFunction = true, functionToRun = function() smasResolutions.changeResolution(true, true) end, multiSelectValueToUse = "resolution", multiSelectValueToSet = "gba", isSaveData = true, isGameData = false, saveDataArgs = 1}
smasMainMenuSystem.addMenuItem{name = "Nintendo 3DS", section = smasMainMenuSystem.menuSections.SECTION_SETTINGS_CHANGERESOLUTION, sectionItem = 8, menuType = smasMainMenuSystem.menuTypes.MENU_MULTISELECT, isFunction = true, functionToRun = function() smasResolutions.changeResolution(true, true) end, multiSelectValueToUse = "resolution", multiSelectValueToSet = "3ds", isSaveData = true, isGameData = false, saveDataArgs = 1}
