...
function fencekoopaVertGreen.onInitAPI()
    npcManager.registerEvent(npcID, fencekoopaVertGreen, "onTickEndNPC")
end
...
function fencekoopaVertGreen.onTickEndNPC(v)
