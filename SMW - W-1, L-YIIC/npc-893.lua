...
function fencekoopaHorizGreen.onInitAPI()
    npcManager.registerEvent(npcID, fencekoopaHorizGreen, "onTickEndNPC")
end
...
function fencekoopaHorizGreen.onTickEndNPC(v)
